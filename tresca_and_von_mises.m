%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% tresca_and_von_mises.m
% Author: Aiden Azarnoush 
% E-mail: a.m.azarnoush@gmail.com
% Description:
% This code create Tresca and von-mises yield surface in principal stress 
% space
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
clf
clc
...
% creat von mise cylinder  with same yield stress
[x1,y1,z1 ]= cylinder(Sy,100);
z1(1,:) = -4;
z1(2,:) = 4;
h2=surf(x1,y1,z1,'LineStyle','none');
rotate(h2, [-1,1,0],54.7356)
